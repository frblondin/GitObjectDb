...
public static class ServiceConfiguration
{
    ...
    public static IServiceCollection AddGitObjectDbGraphQL(this IServiceCollection source, IDataModel model, out DtoTypeEmitter emitter)
    {
        source.AddGitObjectDbApi(model, out emitter);
