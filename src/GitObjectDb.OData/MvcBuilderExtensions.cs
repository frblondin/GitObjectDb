...
namespace GitObjectDb.OData
{
    ...
    public static class MvcBuilderExtensions
    {
        ...
        public static IMvcBuilder AddOData(this IMvcBuilder source, string routePrefix, IDataModel model, Action<ODataOptions> setupAction)
        {
            var applicationPart = new GeneratedTypesApplicationPart(model);
            source.Services.AddAutoMapper(c => c.AddProfile(new AutoMapperProfile(applicationPart)));
            return source
