...
namespace System.Linq
{
    ...
    internal static class IEnumerableExtensions
    {
        ...
        internal static TSource TryGetWithValue<TSource>(this IEnumerable<TSource> source, Func<TSource, string> propertyAccessor, string value, StringComparison comparisonType = StringComparison.OrdinalIgnoreCase)
        {
