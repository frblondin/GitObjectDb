...
namespace GitObjectDb.ModelCodeGeneration
{
    internal static class SyntaxExtensions
    {
        ...
        public static bool IsPublic(this FieldDeclarationSyntax fdSyntax)
        {
            return fdSyntax.Modifiers.Any(x => x.Kind() == SyntaxKind.PublicKeyword);
        }
        ...
        public static bool IsStatic(this FieldDeclarationSyntax fdSyntax)
        {
            return fdSyntax.Modifiers.Any(x => x.Kind() == SyntaxKind.StaticKeyword);
        }
